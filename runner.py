...
def main():
    parser = argparse.ArgumentParser(
        description='WaveletsForestRegressor runner. Use "python -m pydoc random_forest" or see "random_forest.html" for more details.')
    ...
    logging.info(
        'Creating regressor with (regressor=%s, trees=%s, features=%s, depth=%s, seed=%s, criterion=%s, bagging=%s)' % (
        flags.regressor, flags.trees, flags.features, flags.depth, flags.seed, flags.criterion, flags.bagging))
    ...
    regressor = WaveletsForestRegressor(regressor=flags.regressor, trees=flags.trees, features=flags.features,
                                        seed=flags.seed, depth=flags.depth)
